...
import org.kvisions.explorer.schottky.SchottkyExplorer;
import org.kvisions.geom.Complex;
import org.kvisions.geom.schottky.TwinCircles;
import org.kvisions.groups.TwoGensGroup;

public class CommonCircle {
	Complex center;
	Complex a;//�ŏ��̉~�̒��S�����߂�p�����[�^
	Complex p, q, r, s;//���ʉ~���4�_
	double rad;
